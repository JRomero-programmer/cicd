...
class TestCalculate(unittest.TestCase):
    ...
    def test_log_method_returns_correct_result(self):
        ...
        self.assertAlmostEqual(1, self.calc.log(2.7183), places=4)    
    ...
    def test_log_method_fails_with_non_positive_number(self):
        self.assertRaises(TypeError, self.calc.log, 0)
        self.assertRaises(TypeError, self.calc.log, -1)
        self.assertRaises(TypeError, self.calc.log, -100)
